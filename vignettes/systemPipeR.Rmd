...
`SAL` workflow container with the proper connectivity information using using
...
introduced above already, they are included here again for easy reference.
...
The SAL workflow containers of `systemPipeR` offer convenient conversion and
